...
import { CutType, SetPathDataHandler, RealUnit, RealDimensionString } from '../types';
...
export function CutControls({ nodeIds, shapeIsClosed, label, cutDepth: initialCutDepth, cutType: initialCutType, defaultUnits }: CutControlsProps) {
  ...
  const onCutDepthChange = useCallback((value: RealDimensionString | '') => {
